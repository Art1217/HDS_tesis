...
@Composable
fun Level3Screen(onLevelComplete: () -> Unit, onNavigateToMenu: () -> Unit = {}) {
    Game1LevelScreen(config = LEVEL3_CONFIG, onLevelComplete = onLevelComplete, onNavigateToMenu = onNavigateToMenu)
}
